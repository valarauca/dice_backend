...
use super::super::inliner::{InlinedExpression,InlinedCollection,Op as IOp, IntArg as IArg, BoolArg as BArg, BoolOrInt as BI};
    ...
    pub fn new(
        ...
        let item = match expr {
            &InlinedExpression::D6(ref arg) => {
                ...
                OrderedExpression::StdLib(StdLibraryFunc::D6(OrdType::new(self_id, C_I, s_v![(*arg,I)])))
            }
            &InlinedExpression::D3(ref arg) => {
                ...
                // mark that we use it, and how we use it.
                new_coll.set_expr_sink(arg, self_id, I);
                OrderedExpression::StdLib(StdLibraryFunc::D3(OrdType::new(self_id, C_I, s_v![(*arg,I)])))
            }
            &InlinedExpression::Sum(ref arg) => {
                ...
                OrderedExpression::StdLib(StdLibraryFunc::Sum(OrdType::new(self_id, I, s_v![(*arg, C_I)])))
            }
            &InlinedExpression::Max(ref arg) => {
                ...
                // mark that we use it, and how we use it.
                new_coll.set_expr_sink(arg, self_id, C_I);
                OrderedExpression::StdLib(StdLibraryFunc::Max(OrdType::new(self_id, I, s_v![(*arg, C_I)])))
            }
            &InlinedExpression::Min(ref arg) => {
                ...
                // mark that we use it, and how we use it.
                new_coll.set_expr_sink(arg, self_id, C_I);
                OrderedExpression::StdLib(StdLibraryFunc::Min(OrdType::new(self_id, I, s_v![(*arg, C_I)])))
            }
            &InlinedExpression::Count(ref arg) => {
                ...
                OrderedExpression::StdLib(StdLibraryFunc::Count(OrdType::new(self_id, C_B, s_v![(*arg,C_B)])))
            }
            &InlinedExpression::Len(ref arg) => {
                ...
                // mark that we use it, and how we use it.
                new_coll.set_expr_sink(arg, self_id, C_I);
                OrderedExpression::StdLib(StdLibraryFunc::Len(OrdType::new(self_id, C_I, s_v![(*arg,C_I)])))
            }
            &InlinedExpression::Filter(ref a, ref b) => {
                ...
                OrderedExpression::StdLib(StdLibraryFunc::Filter(OrdType::new(self_id, C_I,s_v![(*a,C_B),(*b,C_I)])))
            }
            &InlinedExpression::Join(ref a, ref b) => {
                ...
                OrderedExpression::StdLib(StdLibraryFunc::Join(OrdType::new(self_id, C_I, s_v![(*a,C_I),(*b,C_I)])))
            }
            &InlinedExpression::ConstantInt(ref i) => {
                // no dependent expressions
                OrderedExpression::Constant(ConstantValue::Int(*i, OrdType::new(self_id, I,s_v![])))
            }
            &InlinedExpression::ConstantBool(ref b) => {
                // no dependent expressions
                OrderedExpression::Constant(ConstantValue::Bool(*b, OrdType::new(self_id, B, s_v![])))
            }
            ...
            InlinedExpression::Op(IOp::Add(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Add(OrdType::new(self_id, C_I, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::Add(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Add(OrdType::new(self_id, C_I, s_v![(*a,C_I),(*b,I)])))
            }
            ...
            InlinedExpression::Op(IOp::Sub(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Sub(OrdType::new(self_id, C_I, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::Sub(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Sub(OrdType::new(self_id, C_I, s_v![(*a,C_I),(*b,I)])))
            }
            ...
            InlinedExpression::Op(IOp::Mul(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Mul(OrdType::new(self_id, C_I, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::Mul(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Mul(OrdType::new(self_id, C_I, s_v![(*a,C_I),(*b,I)])))
            }
            ...
            InlinedExpression::Op(IOp::Div(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Div(OrdType::new(self_id, C_I, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::Div(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::Div(OrdType::new(self_id, C_I, s_v![(*a,C_I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::GreaterThan(IArg::Int_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::GreaterThan(OrdType::new(self_id, B, s_v![(*a,I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::GreaterThan(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::GreaterThan(OrdType::new(self_id, C_B, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::GreaterThan(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::GreaterThan(OrdType::new(self_id, C_B, s_v![(*a,C_I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::LessThan(IArg::Int_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::LessThan(OrdType::new(self_id, B, s_v![(*a,I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::LessThan(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::LessThan(OrdType::new(self_id, C_B, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::LessThan(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::LessThan(OrdType::new(self_id, C_B, s_v![(*a,C_I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::LessThanEqual(IArg::Int_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::LessThanEqual(OrdType::new(self_id, B, s_v![(*a,I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::LessThanEqual(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::LessThanEqual(OrdType::new(self_id, C_B, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::LessThanEqual(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::LessThanEqual(OrdType::new(self_id, C_B, s_v![(*a,C_I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::GreaterThanEqual(IArg::Int_Int(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::GreaterThanEqual(OrdType::new(self_id, B, s_v![(*a,I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::GreaterThanEqual(IArg::Int_CollectionOfInt(ref a, ref b))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, I);
                ...
                OrderedExpression::Op(Op::GreaterThanEqual(OrdType::new(self_id, C_B, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::GreaterThanEqual(IArg::CollectionOfInt_Int(ref a, ref b))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, C_I);
                ...
                OrderedExpression::Op(Op::GreaterThanEqual(OrdType::new(self_id, C_B, s_v![(*a,C_I),(*b,I)])))
            }
            ...
            InlinedExpression::Op(IOp::Equal(BI::Int(IArg::Int_CollectionOfInt(ref a, ref b)))) => {
                ...
                OrderedExpression::Op(Op::Equal(OrdType::new(self_id, C_B, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::Equal(BI::Int(IArg::CollectionOfInt_Int(ref a, ref b)))) => {
                ...
                OrderedExpression::Op(Op::Equal(OrdType::new(self_id, C_B, s_v![(*a,C_I),(*b,I)])))
            }
            ...
            InlinedExpression::Op(IOp::Equal(BI::Bool(BArg::Bool_CollectionOfBool(ref a, ref b)))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, B);
                ...
                OrderedExpression::Op(Op::Equal(OrdType::new(self_id, C_B, s_v![(*a,B),(*b,C_B)])))
            }
            InlinedExpression::Op(IOp::Equal(BI::Bool(BArg::CollectionOfBool_Bool(ref a, ref b)))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, C_B);
                ...
                OrderedExpression::Op(Op::Equal(OrdType::new(self_id, C_B, s_v![(*a,C_B),(*b,B)])))
            }
            InlinedExpression::Op(IOp::NotEqual(BI::Int(IArg::Int_Int(ref a, ref b)))) => {
                ...
                OrderedExpression::Op(Op::NotEqual(OrdType::new(self_id, B, s_v![(*a, I), (*b,I)])))
            }
            InlinedExpression::Op(IOp::NotEqual(BI::Int(IArg::Int_CollectionOfInt(ref a, ref b)))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, I);
                ...
                OrderedExpression::Op(Op::NotEqual(OrdType::new(self_id, C_B, s_v![(*a,I),(*b,C_I)])))
            }
            InlinedExpression::Op(IOp::NotEqual(BI::Int(IArg::CollectionOfInt_Int(ref a, ref b)))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, C_I);
                ...
                OrderedExpression::Op(Op::NotEqual(OrdType::new(self_id, C_B, s_v![(*a,C_I),(*b,I)])))
            }
            InlinedExpression::Op(IOp::NotEqual(BI::Bool(BArg::Bool_Bool(ref a, ref b)))) => {
                ...
                OrderedExpression::Op(Op::NotEqual(OrdType::new(self_id, B, s_v![(*a, B), (*b,B)])))
            }
            InlinedExpression::Op(IOp::NotEqual(BI::Bool(BArg::Bool_CollectionOfBool(ref a, ref b)))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, B);
                ...
                OrderedExpression::Op(Op::NotEqual(OrdType::new(self_id, C_B, s_v![(*a,B),(*b,C_B)])))
            }
            InlinedExpression::Op(IOp::NotEqual(BI::Bool(BArg::CollectionOfBool_Bool(ref a, ref b)))) => {
                // ensure `a` is inserted
                let old_arg_a = old_coll.get_expr(a).unwrap();
                OrderedExpression::new(old_arg_a, old_coll, new_coll);
                new_coll.set_expr_sink(a, self_id, C_B);
                ...
                OrderedExpression::Op(Op::NotEqual(OrdType::new(self_id, C_B, s_v![(*a,C_B),(*b,B)])))
            }
            ...
            InlinedExpression::Op(IOp::And(BArg::Bool_CollectionOfBool(ref a, ref b))) => {
                ...
                OrderedExpression::Op(Op::And(OrdType::new(self_id, C_B, s_v![(*a,C_B),(*b,B)])))
            }
...
impl AsRef<OrdType> for ConstantValue {
    ...
    fn as_ref<'a>(&'a self) -> &'a OrdType {
        match self {
            &ConstantValue::Bool(_,ref x) |
            &ConstantValue::Int(_,ref x) => x.as_ref(),
        }
    }
}
impl AsMut<OrdType> for ConstantValue {
    ...
    fn as_mut<'a>(&'a mut self) -> &'a mut OrdType {
        match self {
            &mut ConstantValue::Bool(_,ref mut x) |
            &mut ConstantValue::Int(_,ref mut x) => x.as_mut(),
        }
    }
}
